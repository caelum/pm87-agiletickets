...
public class CalculadoraDePrecos {
	...
	public static BigDecimal calcula(Sessao sessao, Integer quantidade) {
		...
		if(sessao.getEspetaculo().getTipo().equals(TipoDeEspetaculo.CINEMA) || sessao.getEspetaculo().getTipo().equals(TipoDeEspetaculo.SHOW)) {
			...
			preco = variaPrecoIngressoCinemaShow(sessao);
			...
			preco = variaPrecoIngressoBalletOrquestra(sessao);
		}  else {
	...
	private static BigDecimal variaPrecoIngressoBalletOrquestra(Sessao sessao) {
		BigDecimal preco;
	...
	private static BigDecimal variaPrecoIngressoCinemaShow(Sessao sessao) {
		BigDecimal preco;
